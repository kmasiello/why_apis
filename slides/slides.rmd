...
<h7 style="color:#d6d6d6">steps to making a plumber API</h7>
]
...
{{(respponse_raw <- content(response, as = "text"))}}
...
# What have we done?
## `r fa(name = "check-square", fill = "white")` &nbsp; Turned our R code into an API  
## `r fa(name = "check-square", fill = "white")` &nbsp; Call an API for use in R 
